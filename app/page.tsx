        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold  text-[#f1e56c] sm:text-title-xl2">
                Sign In 
              </h2>
              {
                !userFound && 
...
<div className="mb-4">
 ...
 name="user.email" placeholder="provide username or email"  onChange={(event:any)=>{
...
<div className="mb-5">
                  <input
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-[#f1e56c] p-4 text-black transition hover:bg-opacity-90 md:font-bold"
                  />
                </div>
</Form>
        )}
