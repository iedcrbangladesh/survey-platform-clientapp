  ...
  <div className="flex flex-col">
    ...
    <table className='table-auto border-collapse border border-slate-400'>
      <tr className='bg-gray-2 text-left dark:bg-meta-4'>
        ...
        <td className="border border-slate-300 w-2/4 p-1">পৃথক পৃথক ভাবে জিজ্ঞাসা করুন এবং উত্তর লিপিবদ্ধ করুনঃ<br/>যদি গাড়ি বা ঐ ধরনের সামগ্রী অফিস থেকে ব্যবহারের জন্য দেওয়া হয়ে থাকে <br/>তাহলে আমরা সেটাকে হ্যাঁ হিসেবে গণ্য করবো।</td>
      </tr>
    </table>
  </div>
</div>
